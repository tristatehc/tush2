...
@Component({
  ...
  templateUrl: './my-profile.component-part1.html',
            ...
            if(isAuthenticated){
                  this.oktaAuth.getUser().then(user => {
                    ...
                    this.service.getApplicantData(this.loggedInUserEmail).subscribe(info =>{
                        if(info != null){
                            this.currentStatus = "TEST" ; //info.status;
                            if(this.currentStatus == environment.onboardedStatus){
                                this.disable = true;
                            }
                            if(this.currentStatus == environment.onboardedStatus2){
                                this.disable = true;
                            }   
                            if(this.currentStatus == environment.onboardedStatus3){
                                this.disable = true;
                            }
                            if(this.currentStatus == "active"){
                                this.currentStatus = 'activeR'
